package com.hotel.booking.user_services.paystack.controller;

import com.google.common.hash.Hashing;
import com.hotel.booking.user_services.paystack.service.PaystackWebhookService;
...
public class PaystackWebhookController {
    ...
    public ResponseEntity<String> handlePaystackWebhook(@RequestHeader("x-paystack-signature") String signature,
        ...
        String computedSignature = Hashing.sha512().hashString(payload + secretKey.trim(), StandardCharsets.UTF_8).toString();
