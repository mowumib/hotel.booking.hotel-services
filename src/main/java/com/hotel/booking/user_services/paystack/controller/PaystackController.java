...
public class PaystackController {
    ...
    // public ResponseEntity<ResponseModel> fetchTransactionsByLoanCaseCode(
    //         @RequestParam("lcCode") String loanCaseCode) {
    //     ResponseModel responseModel = paystackService.fetchTransactions(loanCaseCode);
    //     return ResponseEntity.status(responseModel.getStatusCode()).body(responseModel);
    // }
}
